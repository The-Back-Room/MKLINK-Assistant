...
REM :: It will prompt for the output path and the input folder to link to.                                                              ::
REM :: The script will handle errors and provide feedback on the success or failure of the operation.                                   ::
...
REM :: Please modify the script as needed for your specific use case.                                                                   ::
REM :: Remember to run this script in a command prompt with administrative privileges.                                                  ::
REM ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
ECHO.
ECHO Make sure the output path does not already exist, and the input folder exists and is accessible.
ECHO.
ECHO Press any key to continue...
PAUSE >NUL
...
ECHO A symlink is a pointer to another folder, allowing you to access it from a different location.
ECHO.
ECHO Please ensure you have the necessary permissions to create symlinks on your system.
ECHO If you encounter any issues, please check the paths and permissions.
ECHO.
ECHO For more information on symlinks, visit:
ECHO - https://docs.microsoft.com/en-us/windows/win32/fileio/symbolic-links
...
PAUSE >NUL
REM Check if the output path already exists
IF EXIST "%OUTPUT%" (
	CLS
	MODE CON COLS=85 LINES=45
	COLOR 4F
	TITLE Error: Output Path Exists
	ECHO :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	ECHO ::                             Error: Output Path Exists                           ::
	ECHO :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	ECHO.
	ECHO The output path "%OUTPUT%" already exists.
	ECHO Please choose a different output path that does not already exist.
	ECHO.
	ECHO If you want to overwrite the existing symlink, please delete it first or choose a new path.
	ECHO.
...
IF %ERRORLEVEL% EQU 0 (
	...
	ECHO - Ensure the output path "%OUTPUT%" does not already exist.
	ECHO - Ensure the input path "%INPUT%" exists and is accessible.
	ECHO - Ensure you have administrative privileges to create symlinks.
	ECHO.
	ECHO If you are using Windows 10 or later, you may need to enable Developer Mode to create symlinks without admin rights.
	ECHO.
	ECHO For more information, visit:
	ECHO - https://docs.microsoft.com/en-us/windows/apps/get-started/enable-developer-mode-in-windows-10
	TIMEOUT /T 10 >NUL
	EXIT /B 1
)